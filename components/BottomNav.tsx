...
const BottomNav: React.FC<Props> = ({ activeTab, onTabChange }) => {
  const tabs = [
    ...
    { id: TabType.GUESS, label: '竞猜', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
  ];

  return (
    <>
      {/* 桌面端侧边导航 */}
      <nav className="hidden sm:flex fixed left-0 top-14 bottom-0 w-20 glass-morphism border-r border-slate-200 z-50 flex-col items-center py-4">
      ...
      {/* 移动端底部导航 */}
      <nav className="sm:hidden fixed bottom-0 left-0 right-0 glass-morphism border-t border-slate-200 z-50 px-2 py-2">
